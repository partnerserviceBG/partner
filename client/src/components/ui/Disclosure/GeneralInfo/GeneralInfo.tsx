...
import { Box, Container, Grid, Link, styled, SvgIcon, Typography } from '@mui/material';
// @ts-ignore
import Info from '@images/svg/info.svg?react';
import { StyledBoxByIcon } from '@components/share/styled-box-by-icon/StyledBoxByIcon.tsx';
...
export const GeneralInfo: FC = () => {
  ...
  return (
    <Container sx={{ width: '100%', marginBottom: '60px' }}>
      ...
      <StyledBoxByIcon>
        <SvgIcon viewBox='0 0 40 40' sx={{ width: '1.8em', height: '1.8em' }} component={Info} />
        <Typography sx={{ marginLeft: '60px' }} variant='h3'>
